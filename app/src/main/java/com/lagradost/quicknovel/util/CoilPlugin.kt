...
class CoilImagesPlugin : AbstractMarkwonPlugin {
    ...
    fun create(context: Context): CoilImagesPlugin {
        return create(context, object : CoilStore {
    ...
    val coilAsyncDrawableLoader: CoilAsyncDrawableLoader

    constructor(context: Context, coilStore: CoilStore, imageLoader: ImageLoader) {
        this.coilAsyncDrawableLoader =
    ...
    class CoilAsyncDrawableLoader internal constructor(
        ...
        private val jobs = ConcurrentHashMap<AsyncDrawable, Job>()
        ...
        private inner class AsyncDrawableTarget(
            ...
            override fun onSuccess(result: coil3.Image) {
                ...
                if (cache.remove(drawable) != null
                    ...
                    jobs[drawable] = job
                    job.invokeOnCompletion { jobs.remove(drawable) }
                }
            }
